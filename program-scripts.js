const gallerySlider = new Swiper(".swiper.is-gallery", {
  ...
  navigation: {
    nextEl: '.button-right',
    prevEl: '.button-left',
  }, // Properly closed navigation object
}); // Properly closed Swiper initialization
...
window.addEventListener('resize', () => {
  handleGridStyles(); // Call the function again to apply grid styles on viewport resize
});
